...
//                          WHITE     RED       ORANGE    GOLD      YELLOW    GREEN     TURQUOISE CYAN      BLUE      PURPLE    MAGENTA   PINK      NULL      NULL      NULL      ON        OFF       BRIGHTER  DIMMER    FLASH (LAVENDER)  SMOOTH (CRIMSON)  SPEED (INDIGO)  BRIGHTNESS 25%  BRIGHTNESS 50%  BRIGHTNESS 75%  BRIGHTNESS 100%
